...
import (
	...
	"log/slog"
	"net"
	{{cookiecutter.service_name}}v1 "protogen/{{cookiecutter.service_name}}/v1"

	grpcadapter "{{cookiecutter.service_name}}/internal/adapters/grpc"
	"{{cookiecutter.service_name}}/internal/application"
